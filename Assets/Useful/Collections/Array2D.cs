...
namespace Useful.Collections
{
    ...
    public class Array2D<T> : IReadOnlyArray2D<T>
    {
        ...
        {
            get => _array[x + Size.x * y];
            set => _array[x + Size.x * y] = value;
        }
        ...
        public void CopyTo(T[] array) => Array.Copy(_array, 0, array, 0, Count);

        public Array2D<T> Clone() => new((T[])_array.Clone(), Size);
