// Taken from https://github.com/dotnet/runtime/blob/main/src/libraries/System.Collections/src/System/Collections/Generic/PriorityQueue.cs and removed errors
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        private void MoveDownDefaultComparer((TElement Element, TPriority Priority) node, int nodeIndex)
        {
            ...
            while ((i = GetFirstChildIndex(nodeIndex)) < size)
            {
                ...
                int childIndexUpperBound = System.Math.Min(i + Arity, size);
