...
namespace Useful.Collections
{
    ...
    public struct BitSet32
    {
        ...
        public readonly bool IsSet(int bit) => (_bits & (1 << bit)) != 0;
        ...
        public readonly bool IsSubsetOf(BitSet32 other) => (_bits & other._bits) == _bits;

        public void SetBit(int bit) => _bits |= 1u << bit;
        public void ResetBit(int bit) => _bits &= ~(1u << bit);
        public void UnionWith(BitSet32 other) => _bits |= other._bits;
        public void IntersectWith(BitSet32 other) => _bits &= other._bits;
        public static BitSet32 Union(BitSet32 a, BitSet32 b) => new(a._bits | b._bits);
        public static BitSet32 Intersect(BitSet32 a, BitSet32 b) => new(a._bits & b._bits);
        public static bool operator ==(BitSet32 a, BitSet32 b) => a._bits == b._bits;
        public static bool operator !=(BitSet32 a, BitSet32 b) => a._bits != b._bits;
        public static BitSet32 operator <<(BitSet32 set, int shift) => new(set._bits << shift);
        public static BitSet32 operator >> (BitSet32 set, int shift) => new(set._bits >> shift);

        public readonly override bool Equals(object obj) => obj is BitSet32 other && this == other;
        public readonly bool Equals(BitSet32 other) => _bits == other._bits;
        public readonly override int GetHashCode() => (int)_bits;
    }
}